...
return [(function (){var pred__37945 = cljs.core.instance_QMARK_;
var expr__37946 = reactive_val;
if(cljs.core.truth_((pred__37945.cljs$core$IFn$_invoke$arity$2 ? pred__37945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__37946) : pred__37945.call(null,reagent.ratom.RAtom,expr__37946)))){
return "ra";
} else {
if(cljs.core.truth_((pred__37945.cljs$core$IFn$_invoke$arity$2 ? pred__37945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__37946) : pred__37945.call(null,reagent.ratom.RCursor,expr__37946)))){
return "rc";
} else {
if(cljs.core.truth_((pred__37945.cljs$core$IFn$_invoke$arity$2 ? pred__37945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__37946) : pred__37945.call(null,reagent.ratom.Reaction,expr__37946)))){
return "rx";
} else {
if(cljs.core.truth_((pred__37945.cljs$core$IFn$_invoke$arity$2 ? pred__37945.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__37946) : pred__37945.call(null,reagent.ratom.Track,expr__37946)))){
return "tr";
} else {
return "other";
}
