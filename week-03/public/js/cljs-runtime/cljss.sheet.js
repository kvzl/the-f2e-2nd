...
var G__32506_32514 = tag;
var G__32507_32515 = goog.dom.createTextNode("");
goog.dom.appendChild(G__32506_32514,G__32507_32515);
...
if(cljs.core.truth_((function (){var fexpr__32508 = cljs.core.deref(self__.cache);
return (fexpr__32508.cljs$core$IFn$_invoke$arity$1 ? fexpr__32508.cljs$core$IFn$_invoke$arity$1(cls_name) : fexpr__32508.call(null,cls_name));
})())){
return null;
} else {
...
var rules_count = (function (){var G__32509 = goog.object.get(self__.sheet,"cssRules");
var G__32510 = "length";
return goog.object.get(G__32509,G__32510);
})();
if(cljss.utils.dev_QMARK_){
var G__32511 = self__.tag;
var G__32512 = goog.dom.createTextNode(rule__$1);
return goog.dom.appendChild(G__32511,G__32512);
} else {
try{return self__.sheet.insertRule(rule__$1,rules_count);
}catch (e32513){var e = e32513;
if(cljss.utils.dev_QMARK_){
