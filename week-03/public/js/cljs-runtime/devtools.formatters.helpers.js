...
var G__27452 = devtools.prefs.pref(v);
v = G__27452;
continue;
} else {
return v;
...
}catch (e27403){var _e__26934__auto__ = e27403;
return false;
}})();
...
}catch (e27407){var _e__26934__auto__ = e27407;
return false;
}})();
...
}catch (e27409){var _e__26934__auto__ = e27409;
return false;
}}
}
});
...
var vec__27425 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27425,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27425,(1),null);
...
return cljs.core.some((function (p1__27430_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27430_SHARP_);
}),template);
});
