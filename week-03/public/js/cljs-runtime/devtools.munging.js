...
var o27145 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27145["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27146 = temp__5733__auto____$1;
return (o27146["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26925__auto__ = f;
return (o__26925__auto__["toString"]).call(o__26925__auto__);
} else {
return "";
}
...
try{var o__26925__auto___27389 = t;
(o__26925__auto___27389["cljs$lang$ctorPrWriter"]).call(o__26925__auto___27389,t,writer);
}catch (e27149){var __27391 = e27149;
}
...
var char_code = (function (){var o__26925__auto__ = (new String(char$));
return (o__26925__auto__["charCodeAt"]).call(o__26925__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26925__auto__ = String;
return (o__26925__auto__["fromCharCode"]).call(o__26925__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27161 = num_code;
switch (G__27161) {
case (1):
return (185);
...
var o__26925__auto__ = String;
return (o__26925__auto__["fromCharCode"]).call(o__26925__auto__,superscript_code);
});
/**
...
}catch (e27168){var _e__26934__auto__ = e27168;
return false;
}})())){
...
var vec__27172 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27172,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27193 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27193["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27194 = temp__5733__auto____$1;
return (o27194["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27200){
var vec__27202 = p__27200;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27202,(0),null);
...
var G__27421 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27422 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27421;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27195){
var G__27196 = cljs.core.first(seq27195);
var seq27195__$1 = cljs.core.next(seq27195);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27196,seq27195__$1);
});
...
var vec__27211 = cljs.core.split_with((function (p1__27210_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27210_SHARP_,"arity");
}),tokens);
...
var vec__27223 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27223,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27223,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27436 = cljs.core.rest(remaining_tokens);
var G__27437 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27436;
name_tokens = G__27437;
continue;
} else {
...
var vec__27229 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27229,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27229,(1),null);
var vec__27232 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27232,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27232,(1),null);
var vec__27235 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27235,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27235,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27235,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27235,(3),null);
...
var vec__27242 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27242,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27256 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27256,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27256,(1),null);
var vec__27259 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27259,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27259,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27263 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27263) : devtools.munging.parse_fn_info_deep.call(null,G__27263));
})()));
}
} else {
return fn_info;
...
var G__27468 = (arity + (1));
var G__27469 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27278){
var vec__27279 = p__27278;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27279,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27283_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27284_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___27477 = arguments.length;
var i__4731__auto___27478 = (0);
while(true){
if((i__4731__auto___27478 < len__4730__auto___27477)){
args__4736__auto__.push((arguments[i__4731__auto___27478]));

var G__27479 = (i__4731__auto___27478 + (1));
i__4731__auto___27478 = G__27479;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27302){
var vec__27303 = p__27302;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27303,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27288){
var G__27289 = cljs.core.first(seq27288);
var seq27288__$1 = cljs.core.next(seq27288);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27289,seq27288__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27327__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27327__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27327__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27327__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27328 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27328,(5),null);
...
var o__26925__auto__ = f;
return (o__26925__auto__["getBasis"]).call(o__26925__auto__);
});
/**
...
}catch (e27342){var _e__26934__auto__ = e27342;
...
var G__27501 = (obj[cljs.core.first(path)]);
var G__27502 = cljs.core.rest(path);
obj = G__27501;
path = G__27502;
continue;
} else {
...
return (function (accum,p__27363){
var vec__27364 = p__27363;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27364,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27364,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27367){
var vec__27368 = p__27367;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27368,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27368,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27368,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27384,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27384,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__27384,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27375_SHARP_){
return (obj[cljs.core.first(p1__27375_SHARP_)]);
});})(name,sorted_matches,vec__27384,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
