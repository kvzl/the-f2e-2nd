...
var o__26925__auto___28997 = (function (){var o__26925__auto__ = (function (){var o__26925__auto__ = Promise;
return (o__26925__auto__["resolve"]).call(o__26925__auto__);
})();
return (o__26925__auto__["then"]).call(o__26925__auto__,callback);
})();
(o__26925__auto___28997["catch"]).call(o__26925__auto___28997,devtools.async.rethrow_outside_promise);
...
var G__28990_29010 = Error;
var target__26931__auto___29011 = G__28990_29010;
if(cljs.core.truth_(target__26931__auto___29011)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28990_29010)].join(''),"\n","target__26931__auto__"].join('')));
}

(target__26931__auto___29011["stackTraceLimit"] = Infinity);
