...
var G__37533 = o;
(G__37533[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37680__i < G__37680__a.length) {G__37680__a[G__37680__i] = arguments[G__37680__i + 0]; ++G__37680__i;}
  args = new cljs.core.IndexedSeq(G__37680__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37681);
...
var G__37538 = o;
(G__37538[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37687__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37688__i < G__37688__a.length) {G__37688__a[G__37688__i] = arguments[G__37688__i + 0]; ++G__37688__i;}
  args = new cljs.core.IndexedSeq(G__37688__a,0,null);
} 
return G__37687__delegate.call(this,args);};
G__37687.cljs$lang$maxFixedArity = 0;
G__37687.cljs$lang$applyTo = (function (arglist__37689){
var args = cljs.core.seq(arglist__37689);
return G__37687__delegate(args);
});
...
var G__37545 = props;
var G__37545__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37545,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37545);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37545__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37546){
...
var props = map__37547__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37547__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__37547,map__37547__$1,props,class$){
return (function (c){
...
});})(map__37547,map__37547__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37552){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37553__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37553,map__37553__$1,on_write){
return (function (){
...
});})(node_value,map__37553,map__37553__$1,on_write))
);
} else {
...
var G__37579 = jsprops;
(G__37579["defaultValue"] = value);

(G__37579["onChange"] = ((function (G__37579,v,value,on_change){
return (function (p1__37577_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37577_SHARP_);
});})(G__37579,v,value,on_change))
);
...
var vec__37594 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37594,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37594,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37594,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37744 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37744 == null)){
} else {
var key_37745 = temp__5739__auto___37744;
...
var temp__5739__auto___37749 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37749 == null)){
} else {
var key_37750 = temp__5739__auto___37749;
reagent.impl.template.oset(jsprops,"key",key_37750);
}
...
var G__37613 = reagent.impl.template.__GT_NativeWrapper();
(G__37613["name"] = c);
...
var G__37616 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37616) : reagent.impl.template.as_element.call(null,G__37616));
} else {
...
var len__4730__auto___37761 = arguments.length;
var i__4731__auto___37762 = (0);
while(true){
if((i__4731__auto___37762 < len__4730__auto___37761)){
args__4736__auto__.push((arguments[i__4731__auto___37762]));

var G__37763 = (i__4731__auto___37762 + (1));
i__4731__auto___37762 = G__37763;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37621){
...
break;
default:
var G__37770 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37770;
continue;
...
var n__4607__auto___37780 = a.length;
var i_37781 = (0);
while(true){
if((i_37781 < n__4607__auto___37780)){
(a[i_37781] = reagent.impl.template.as_element((a[i_37781])));

var G__37783 = (i_37781 + (1));
i_37781 = G__37783;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37788 = a.length;
var i_37789 = (0);
while(true){
if((i_37789 < n__4607__auto___37788)){
var val_37790 = (a[i_37789]);
if(((cljs.core.vector_QMARK_(val_37790)) && ((reagent.impl.template.key_from_vec(val_37790) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37789] = reagent.impl.template.as_element(val_37790));

var G__37791 = (i_37789 + (1));
i_37789 = G__37791;
continue;
} else {
}
...
var ctx = ({});
var vec__37643 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37643,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37643,(1),null);
...
var G__37649 = (cljs.core.count(argv) - first_child);
switch (G__37649) {
case (0):
...
case (1):
var G__37650 = comp;
var G__37651 = jsprops;
var G__37652 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37650,G__37651,G__37652);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37649){
