...
if((i < len)){
var k = (ks[i]);
var G__37530 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__37531 = (i + (1));
m = G__37530;
i = G__37531;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__37029 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__37029);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37034 = c;
var G__37034__$1 = (((G__37034 == null))?null:G__37034.prototype);
if((G__37034__$1 == null)){
return null;
} else {
return (G__37034__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37084 = c;
var G__37084__$1 = (((G__37084 == null))?null:G__37084.prototype);
if((G__37084__$1 == null)){
return null;
} else {
return (G__37084__$1["render"]);
}
})() == null)))));
});
...
var G__37168 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__37168) : reagent.impl.component.as_element.call(null,G__37168));
};
...
G__37550.cljs$lang$applyTo = (function (arglist__37565){
...
var _STAR_current_component_STAR__orig_val__37173 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37174 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37174;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37173;
}});
...
return ((function (G__37193,G__37193__$1){
...
var c = this;
var G__37306_37580 = (c["cljsRatom"]);
if((G__37306_37580 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37306_37580);
}
...
var renders_37584 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_37585 = cljs.core.first(cljs.core.vals(renders_37584));
if((cljs.core.count(renders_37584) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37584))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37585)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37585], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__37404 = name;
switch (G__37404) {
case "":
...
var G__37410 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__37410);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__37427 = fiber;
var G__37427__$1 = (((G__37427 == null))?null:(G__37427["type"]));
if((G__37427__$1 == null)){
return null;
} else {
return (G__37427__$1["displayName"]);
}
})();
var parent = (function (){var G__37442 = fiber;
if((G__37442 == null)){
return null;
} else {
return (G__37442["return"]);
}
})();
var path = (function (){var G__37443 = parent;
var G__37443__$1 = (((G__37443 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__37443) : reagent.impl.component.fiber_component_path.call(null,G__37443)));
if((G__37443__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37443__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__37447 = c;
if((G__37447 == null)){
return null;
} else {
return (G__37447["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__37458._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__37473 = c;
if((G__37473 == null)){
return null;
} else {
return (G__37473["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__37478 = c;
if((G__37478 == null)){
return null;
} else {
return G__37478._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__37482 = instance;
if((G__37482 == null)){
return null;
} else {
return (G__37482["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__37483 = instance;
if((G__37483 == null)){
return null;
} else {
return G__37483._currentElement;
}
}
})();
...
var owner = (function (){var or__4131__auto__ = (function (){var G__37497 = elem;
if((G__37497 == null)){
return null;
} else {
return (G__37497["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__37498._owner;
}
}
})();
var path = (function (){var G__37499 = owner;
var G__37499__$1 = (((G__37499 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__37499) : reagent.impl.component.component_path.call(null,G__37499)));
if((G__37499__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37499__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__37500 = c;
var G__37500__$1 = (((G__37500 == null))?null:G__37500.constructor);
if((G__37500__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__37500__$1);
}
}
})();
