...
var G__30389 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30389;
continue;
} else {
return ch;
...
var vec__30349 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30349,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30379){
...
return (function() { 
var G__30459__delegate = function (rdr,_){
...
var G__30459 = function (rdr,var_args){
var _ = null;
...
while (G__30460__i < G__30460__a.length) {G__30460__a[G__30460__i] = arguments[G__30460__i + 1]; ++G__30460__i;}
  _ = new cljs.core.IndexedSeq(G__30460__a,0,null);
} 
return G__30459__delegate.call(this,rdr,_);};
G__30459.cljs$lang$maxFixedArity = 1;
G__30459.cljs$lang$applyTo = (function (arglist__30461){
var rdr = cljs.core.first(arglist__30461);
var _ = cljs.core.rest(arglist__30461);
return G__30459__delegate(rdr,_);
});
