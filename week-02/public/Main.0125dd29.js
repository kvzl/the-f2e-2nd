...
var author$project$Main$assetsPath = '/assets/';
...
var author$project$Main$getPokerUrl = function (name) {
	var pokerPath = author$project$Main$assetsPath + 'cards_background/';
	return pokerPath + (name + '.png');
};
...
var author$project$Main$king = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('king')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$src(author$project$Main$assetsPath + '/king_joy.png')
				]),
			_List_Nil)
		]));
var author$project$Main$poker = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('poker')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$getPokerUrl('S3'))
				]),
			_List_Nil),
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$src(
					author$project$Main$getPokerUrl('S5'))
				]),
			_List_Nil)
		]));
...
var author$project$Main$view = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('free-cell')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('free-cell__top')
				]),
			_List_fromArray(
				[author$project$Main$poker])),
			A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('free-cell__main')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('free-cell__bottom')
				]),
			_List_fromArray(
				[
