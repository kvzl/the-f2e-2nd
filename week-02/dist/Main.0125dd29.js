...
var author$project$Colors$gray1 = rtfeldman$elm_css$Css$hex('E2E2E2');
...
var author$project$Main$freeCell = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$backgroundColor(author$project$Colors$gray1)
		]));
var author$project$Colors$light = rtfeldman$elm_css$Css$hex('F2F2F2');
...
var author$project$Main$bordered = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A6(
...
var author$project$Main$flexCenter = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var author$project$Main$cell = A2(
	...
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$px(95)),
			rtfeldman$elm_css$Css$height(
			rtfeldman$elm_css$Css$px(145)),
			rtfeldman$elm_css$Css$borderRadius(
			rtfeldman$elm_css$Css$px(5)),
			author$project$Main$flexCenter,
			rtfeldman$elm_css$Css$overflow(rtfeldman$elm_css$Css$hidden)
		]));
var author$project$FreeCell$assetsPath = 'assets/';
...
var author$project$Main$logoText = A2(
	rtfeldman$elm_css$Html$Styled$styled,
...
var author$project$Main$king = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$src(author$project$FreeCell$assetsPath + '/king_happy.png'),
			...
			_List_Nil),
			A2(
			author$project$Main$logoText,
			_List_Nil,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('FreeCell')
				]))
		]));
var author$project$Main$getSuitUrl = function (name) {
	return author$project$FreeCell$assetsPath + (name + '.png');
};
var rtfeldman$elm_css$Css$PercentageUnits = {$: 'PercentageUnits'};
var rtfeldman$elm_css$Css$pct = A2(rtfeldman$elm_css$Css$Internal$lengthConverter, rtfeldman$elm_css$Css$PercentageUnits, '%');
var author$project$Main$suitCard = function (name) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$backgroundColor(author$project$Colors$light),
						rtfeldman$elm_css$Css$width(
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$getSuitUrl(name)),
						rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
								rtfeldman$elm_css$Css$width(
...
var author$project$Main$top = A2(
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$Attributes$css(
	...
	_List_fromArray(
		[
			...
			_List_Nil),
			author$project$Main$king,
			A2(
			author$project$Main$cell,
			_List_Nil,
			_List_fromArray(
				[
					author$project$Main$suitCard('S')
				])),
			A2(
			author$project$Main$cell,
			_List_Nil,
			_List_fromArray(
				[
					author$project$Main$suitCard('H')
				])),
			A2(
			author$project$Main$cell,
			_List_Nil,
			_List_fromArray(
				[
					author$project$Main$suitCard('D')
				])),
			A2(
			author$project$Main$cell,
			_List_Nil,
			_List_fromArray(
				[
					author$project$Main$suitCard('C')
				]))
		]));
var author$project$Main$view = A2(
	author$project$Main$freeCell,
	_List_Nil,
	_List_fromArray(
		[
			A2(
...
var author$project$Main$main = rtfeldman$elm_css$Html$Styled$toUnstyled(author$project$Main$view);
...
},{}]},{},["../../../../../.nvm/versions/node/v11.15.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/Main.elm"], null)
//# sourceMappingURL=/Main.0125dd29.js.map